...
A distancia percorrida de cada individuo e dada pelo somatorio da diferenca de cada ponto pelo
 seu anterior, dada pelos seus genes, 
mais a distancia de percorrida para contornar os 
obstaculos.

Para classificacao dos resultados, eu utilizei como avaliacao o inverso da distancia
percorrida de cada individuo da entrada ate a saida,
de forma que quanto menor a distancia,
maior a aptidao.
